Nenne den allgemeinen Reaktionsvorgang eines Enzyms.
?
...
Welche Hemmung verändert $K_{m}$, welche nicht? := Nicht-Kompetitive Hemmung verändert $K_{m}$ nicht, da die Affinität des Enzyms zum Substrat unverändert ist.

Wie wirkt ein kompetitiver Hemmstoff? := Inhibitor verhindert Bindung des Substrats an aktives Zentrum und setzt so die Affinität des Enzyms zum Substrat und damit $K_{m}$ herab.

Wie wirkt ein nicht-kompetitiver Hemmstoff? := Inhibitor bindet an allosterisches Zentrum und reduziert so die Effizienz des Enzyms
  ...
  "node_modules/chart.xkcd/dist/index.js"(exports, module2) {
    (function () {
      ...
      var rd = function (e2) {
        ...
        for (
          var r2 = this._groups, t2 = r2.length, a2 = new Array(t2), l2 = 0;
          l2 < t2;
          ++l2
        )
          for (
            var $2,
              ...
              o2 = r2[l2],
              n2 = o2.length,
              i2 = (a2[l2] = new Array(n2)),
              p2 = 0;
            p2 < n2;
            ++p2
          )
            ($2 = o2[p2]) &&
              (_2 = e2.call($2, $2.__data__, p2, o2)) &&
              ("__data__" in $2 && (_2.__data__ = $2.__data__), (i2[p2] = _2));
      ...
      var ud = function (e2) {
        ...
        for (
          var r2 = this._groups, p2 = r2.length, t2 = [], $2 = [], f2 = 0;
          f2 < p2;
          ++f2
        )
          for (var l2, o2 = r2[f2], a2 = o2.length, u2 = 0; u2 < a2; ++u2)
            (l2 = o2[u2]) &&
              (t2.push(e2.call(l2, l2.__data__, u2, o2)), $2.push(l2));
        return new m(t2, $2);
      };
      var vd = function (r2) {
        return function () {
      ...
      var wd = function (r2) {
        ...
        for (
          var e2 = this._groups, a2 = e2.length, t2 = new Array(a2), $2 = 0;
          $2 < a2;
          ++$2
        )
          for (
            var S2, o2 = e2[$2], n2 = o2.length, p2 = (t2[$2] = []), i2 = 0;
            i2 < n2;
            ++i2
          )
      ...
      function ia(e2, t2) {
        (this.ownerDocument = e2.ownerDocument),
          (this.namespaceURI = e2.namespaceURI),
          (this._next = null),
          (this._parent = e2),
          (this.__data__ = t2);
      }
      ...
      function zd(r2, e2, n2, $2, t2, a2) {
        for (var c2, i2 = 0, o2 = e2.length, l2 = a2.length; i2 < l2; ++i2)
          (c2 = e2[i2])
            ? ((c2.__data__ = a2[i2]), ($2[i2] = c2))
            : (n2[i2] = new ia(r2, a2[i2]));
      ...
      function Ad(r2, e2, n2, $2, t2, a2, c2) {
        ...
        for (i2 = 0; i2 < q2; ++i2)
          (o2 = e2[i2]) &&
            ((O2[i2] = l2 = Bb + c2.call(o2, o2.__data__, i2, e2)),
            l2 in f2 ? (t2[i2] = o2) : (f2[l2] = o2));
        for (i2 = 0; i2 < _2; ++i2)
          (o2 = f2[(l2 = Bb + c2.call(r2, a2[i2], i2, a2))])
            ? (($2[i2] = o2), (o2.__data__ = a2[i2]), (f2[l2] = null))
            : (n2[i2] = new ia(r2, a2[i2]));
        for (i2 = 0; i2 < q2; ++i2)
      ...
      var Bd = function (r2, e2) {
        if (!r2)
          return (
            (O2 = new Array(this.size())),
            (l2 = -1),
            this.each(function (r3) {
              O2[++l2] = r3;
            }),
            O2
          );
        ...
        for (
          ...
          var f2 = $2[l2],
            q2 = t2[l2],
            _2 = q2.length,
            O2 = r2.call(f2, f2 && f2.__data__, l2, $2),
            d2 = O2.length,
            u2 = (i2[l2] = new Array(d2)),
            v2 = (c2[l2] = new Array(d2));
      ...
      var Dd = function (e2, t2, r2) {
        var $2 = this.enter(),
          ...
          o2 = this.exit();
        return (
          ($2 = "function" == typeof e2 ? e2($2) : $2.append(e2 + "")),
          null != t2 && (n2 = t2(n2)),
          null == r2 ? o2.remove() : r2(o2),
          $2 && n2 ? $2.merge(n2).order() : n2
        );
      };
      var Ed = function (r2) {
        for (
      ...
      var Fd = function () {
        for (var e2 = this._groups, t2 = -1, r2 = e2.length; ++t2 < r2; )
          for (
            var o2, $2 = e2[t2], n2 = $2.length - 1, a2 = $2[n2];
            --n2 >= 0;

          )
            (o2 = $2[n2]) &&
              (a2 &&
                4 ^ o2.compareDocumentPosition(a2) &&
      ...
      var Gd = function (r2) {
        ...
        r2 || (r2 = Hd);
        for (
          var t2 = this._groups, n2 = t2.length, $2 = new Array(n2), a2 = 0;
          a2 < n2;
          ++a2
        ) {
          for (
      ...
      function Td(t2, r2) {
        return function () {
          ...
          null == e2
            ? this.removeAttributeNS(t2.space, t2.local)
            : this.setAttributeNS(t2.space, t2.local, e2);
        };
      }
      ...
      var Db = function (e2) {
        ...
        return (
          a2 >= 0 &&
            "xmlns" !== ($2 = e2.slice(0, a2)) &&
            (e2 = e2.slice(a2 + 1)),
          Cb.hasOwnProperty($2) ? { space: Cb[$2], local: e2 } : e2
        );
      };
      var Ud = function (t2, r2) {
        ...
        if (arguments.length < 2) {
          var a2 = this.node();
          return e2.local
            ? a2.getAttributeNS(e2.space, e2.local)
            : a2.getAttribute(e2);
        }
        return this.each(
          (null == r2
      ...
      function Xd(e2, t2, r2) {
        return function () {
          ...
          null == $2
            ? this.style.removeProperty(e2)
            : this.style.setProperty(e2, $2, r2);
        };
      }
      var Eb = function (e2) {
        return (
          (e2.ownerDocument && e2.ownerDocument.defaultView) ||
          (e2.document && e2) ||
          e2.defaultView
        );
      };
      var Yd = function (e2, t2, r2) {
        return arguments.length > 1
          ? this.each(
              (null == t2 ? Vd : "function" == typeof t2 ? Xd : Wd)(
                e2,
                t2,
                null == r2 ? "" : r2
              )
      ...
      function Zd(e2, t2) {
        return (
          e2.style.getPropertyValue(t2) ||
          Eb(e2).getComputedStyle(e2, null).getPropertyValue(t2)
        );
      }
      function $d(r2) {
        return function () {
      ...
      var be = function (r2, t2) {
        return arguments.length > 1
          ? this.each(
              (null == t2 ? $d : "function" == typeof t2 ? ae : _d)(r2, t2)
            )
          : this.node()[r2];
      };
      function Fb(s2) {
      ...
      var fe = function (s2, t2) {
        ...
        if (arguments.length < 2) {
          for (var $2 = Ia(this.node()), e2 = -1, n2 = a2.length; ++e2 < n2; )
            if (!$2.contains(a2[e2])) return false;
          return true;
        }
      ...
      var je = function (t2) {
        return arguments.length
          ? this.each(null == t2 ? ge : ("function" == typeof t2 ? ie : he)(t2))
      ...
      var ne = function (n2) {
        return arguments.length
          ? this.each(null == n2 ? ke : ("function" == typeof n2 ? me : le)(n2))
          : this.node().innerHTML;
      };
      function oe() {
      ...
      function se(e2) {
        return function () {
          var r2 = this.ownerDocument,
            t2 = this.namespaceURI;
          return t2 === Ha && r2.documentElement.namespaceURI === Ha
            ? r2.createElement(e2)
            : r2.createElementNS(t2, e2);
        };
      }
      function te(e2) {
        return function () {
      ...
      var we = function (t2, r2) {
        var e2 = "function" == typeof t2 ? t2 : Jb(t2),
          $2 = null == r2 ? ve : "function" == typeof r2 ? r2 : zb(r2);
        return this.select(function () {
          return this.insertBefore(
            e2.apply(this, arguments),
            $2.apply(this, arguments) || null
          );
        });
      };
      function xe() {
      ...
      if ("undefined" != typeof document) {
        ...
        "onmouseenter" in Ee ||
          (De = { mouseenter: "mouseover", mouseleave: "mouseout" });
      }
      function Fe(e2, t2, n2) {
        return (
          ...
          function (t3) {
            ...
            (n3 && (n3 === this || 8 & n3.compareDocumentPosition(this))) ||
              e2.call(this, t3);
          }
        );
      }
        ...
        return e2
          ...
          .map(function (e3) {
            var t2 = "",
              n2 = e3.indexOf(".");
            return (
              n2 >= 0 && ((t2 = e3.slice(n2 + 1)), (e3 = e3.slice(0, n2))),
              { type: e3, name: t2 }
            );
          });
      }
        ...
        return function () {
          ...
          if (t2) {
            for (var n2, r2 = 0, $2 = -1, i2 = t2.length; r2 < i2; ++r2)
              (n2 = t2[r2]),
                (e2.type && n2.type !== e2.type) || n2.name !== e2.name
                  ? (t2[++$2] = n2)
                  : this.removeEventListener(n2.type, n2.listener, n2.capture);
      ...
      function Ie(e2, t2, n2) {
        ...
        return function ($2, i2, p2) {
          ...
          this.addEventListener(e2.type, v2, n2),
            (o2 = {
              type: e2.type,
              name: e2.name,
              value: t2,
      ...
      var Je = function (e2, t2, n2) {
        ...
        if (!(arguments.length < 2)) {
          for (
            o2 = t2 ? Ie : He, null == n2 && (n2 = false), r2 = 0;
            r2 < p2;
            ++r2
          )
      ...
      function Mb(t2, n2, e2) {
        ...
        "function" == typeof a2
          ? (a2 = new a2(n2, e2))
          : ((a2 = $2.document.createEvent("Event")),
            e2
              ? (a2.initEvent(n2, e2.bubbles, e2.cancelable),
                (a2.detail = e2.detail))
              : a2.initEvent(n2, false, false)),
          t2.dispatchEvent(a2);
      }
      function Ke(t2, n2) {
        return function () {
      ...
      var f = function (e2) {
        return "string" == typeof e2
          ? new m([[document.querySelector(e2)]], [document.documentElement])
          : new m([[e2]], Ne);
      };
      var Oe = function () {
        for (var e2, r2 = Kb; (e2 = r2.sourceEvent); ) r2 = e2;
        return r2;
      };
      var Pe = function (e2, t2) {
        ...
        if (n2.createSVGPoint) {
          ...
          return (
            (r2.x = t2.clientX),
            (r2.y = t2.clientY),
            [(r2 = r2.matrixTransform(e2.getScreenCTM().inverse())).x, r2.y]
          );
        }
        var i2 = e2.getBoundingClientRect();
        return [
          t2.clientX - i2.left - e2.clientLeft,
          t2.clientY - i2.top - e2.clientTop,
        ];
      };
      var w = function (e2) {
        var $2 = Oe();
      ...
      function ja() {
        ...
        function d2() {
          var t3 = e2().length,
            ...
            p2 = d3 ? a2 : u2,
            c2 = d3 ? u2 : a2;
          (n2 = (c2 - p2) / Math.max(1, t3 - $2 + 2 * l2)),
            o2 && (n2 = Math.floor(n2)),
            (p2 += (c2 - p2 - n2 * (t3 - $2)) * g2),
            (r2 = n2 * (1 - $2)),
            o2 && ((p2 = Math.round(p2)), (r2 = Math.round(r2)));
        ...
        return (
          ...
          (t2.align = function (n3) {
            return arguments.length
              ? ((g2 = Math.max(0, Math.min(1, n3))), d2())
              : g2;
          }),
          (t2.copy = function () {
            return ja(e2(), [u2, a2])
      ...
      function Nb(n2) {
        var r2 = n2.copy;
        return (
          (n2.padding = n2.paddingOuter),
          delete n2.paddingInner,
          delete n2.paddingOuter,
          (n2.copy = function () {
            return Nb(r2());
          }),
          n2
      ...
      var Pb = function (r2) {
        return (
          1 === r2.length && (r2 = Re(r2)),
          {
            left: function (n2, t2, e2, $2) {
              for (
                null == e2 && (e2 = 0), null == $2 && ($2 = n2.length);
                e2 < $2;
      ...
      var Te = function (t2, e2, r2) {
        ...
        for (
          var $2 = -1,
            a2 = 0 | Math.max(0, Math.ceil((e2 - t2) / r2)),
            c2 = new Array(a2);
          ++$2 < a2;
      ...
      var Ja = Math.sqrt(50),
        ...
        Ue = function ($2, t2, r2) {
          ...
          if (
            ((e2 = t2 < $2) && ((a2 = $2), ($2 = t2), (t2 = a2)),
            0 === (g2 = ka($2, t2, r2)) || !isFinite(g2))
          )
            return [];
          if (g2 > 0)
            for (
              $2 = Math.ceil($2 / g2),
                t2 = Math.floor(t2 / g2),
                o2 = new Array((a2 = Math.ceil(t2 - $2 + 1)));
              ++z2 < a2;
            ...
            for (
              $2 = Math.floor($2 * g2),
                t2 = Math.ceil(t2 * g2),
                o2 = new Array((a2 = Math.ceil($2 - t2 + 1)));
              ++z2 < a2;
      ...
      function ka($2, t2, r2) {
        var e2 = (t2 - $2) / Math.max(0, r2),
          a2 = Math.floor(Math.log(e2) / Math.LN10),
          o2 = e2 / Math.pow(10, a2);
        return a2 >= 0
          ? (o2 >= Ja ? 10 : o2 >= Ka ? 5 : o2 >= La ? 2 : 1) * Math.pow(10, a2)
          : -Math.pow(10, -a2) /
              (o2 >= Ja ? 10 : o2 >= Ka ? 5 : o2 >= La ? 2 : 1);
      }
      function Ma($2, t2, r2) {
        var e2 = Math.abs(t2 - $2) / Math.max(0, r2),
          a2 = Math.pow(10, Math.floor(Math.log(e2) / Math.LN10)),
          o2 = e2 / a2;
        return (
          o2 >= Ja ? (a2 *= 10) : o2 >= Ka ? (a2 *= 5) : o2 >= La && (a2 *= 2),
          t2 < $2 ? -a2 : a2
        );
      }
      function la(t2, e2) {
          ...
          (t2.nice = function ($2) {
            ...
            return (
              k2 < a2 &&
                ...
                (o2 = e2)),
              (e2 = ka(a2, k2, $2)) > 0
                ? ((a2 = Math.floor(a2 / e2) * e2),
                  (k2 = Math.ceil(k2 / e2) * e2),
                  (e2 = ka(a2, k2, $2)))
                : e2 < 0 &&
                  ((a2 = Math.ceil(a2 * e2) / e2),
                  (k2 = Math.floor(k2 * e2) / e2),
                  (e2 = ka(a2, k2, $2))),
              e2 > 0
                ? ((i2[n2] = Math.floor(a2 / e2) * e2),
                  (i2[o2] = Math.ceil(k2 / e2) * e2),
                  r2(i2))
                : e2 < 0 &&
                  ((i2[n2] = Math.ceil(a2 * e2) / e2),
                  (i2[o2] = Math.floor(k2 * e2) / e2),
                  r2(i2)),
              t2
            );
          }),
      ...
      var I = "\\s*([+-]?\\d+)\\s*",
        ...
        We = /^#([0-9a-f]{3})$/,
        Xe = /^#([0-9a-f]{6})$/,
        Ye = new RegExp("^rgb\\(" + [I, I, I] + "\\)$"),
        Ze = new RegExp("^rgb\\(" + [e, e, e] + "\\)$"),
        $e = new RegExp("^rgba\\(" + [I, I, I, R] + "\\)$"),
        _e = new RegExp("^rgba\\(" + [e, e, e, R] + "\\)$"),
        af = new RegExp("^hsl\\(" + [R, e, e] + "\\)$"),
        bf = new RegExp("^hsla\\(" + [R, e, e, R] + "\\)$"),
        Tb = {
          aliceblue: 15792383,
      ...
      function S(r2) {
        var a2;
        return (
          (r2 = (r2 + "").trim().toLowerCase()),
          (a2 = We.exec(r2))
            ? new g(
                (((a2 = parseInt(a2[1], 16)) >> 8) & 15) | ((a2 >> 4) & 240),
                ((a2 >> 4) & 15) | (240 & a2),
                ((15 & a2) << 4) | (15 & a2),
                1
              )
            ...
            : (a2 = af.exec(r2))
            ? $b(a2[1], a2[2] / 100, a2[3] / 100, 1)
            : (a2 = bf.exec(r2))
            ? $b(a2[1], a2[2] / 100, a2[3] / 100, a2[4])
            : Tb.hasOwnProperty(r2)
            ? Wb(Tb[r2])
            : "transparent" === r2
            ? new g(NaN, NaN, NaN, 0)
            : null
      ...
      function Na(r2) {
        return (
          r2 instanceof x || (r2 = S(r2)),
          r2 ? new g((r2 = r2.rgb()).r, r2.g, r2.b, r2.opacity) : new g()
        );
      }
      function ma(r2, a2, e2, $2) {
        return 1 === arguments.length
          ? Na(r2)
          : new g(r2, a2, e2, null == $2 ? 1 : $2);
      }
      ...
      function Zb() {
        var r2 = this.opacity;
        return (
          (1 === (r2 = isNaN(r2) ? 1 : Math.max(0, Math.min(1, r2)))
            ? "rgb("
            : "rgba(") +
      ...
      function Oa(r2) {
        return (
          ((r2 = Math.max(0, Math.min(255, Math.round(r2) || 0))) < 16
            ? "0"
            : "") + r2.toString(16)
        );
      }
      ...
      function _b(r2) {
        ...
        if ((r2 instanceof x || (r2 = S(r2)), !r2)) return new s();
        if (r2 instanceof s) return r2;
        var a2 = (r2 = r2.rgb()).r / 255,
          e2 = r2.g / 255,
          $2 = r2.b / 255,
          t2 = Math.min(a2, e2, $2),
          o2 = Math.max(a2, e2, $2),
          ...
          i2
            ? ((n2 =
                a2 === o2
                  ...
                  ? ($2 - a2) / i2 + 2
                  : (a2 - e2) / i2 + 4),
              (i2 /= f2 < 0.5 ? o2 + t2 : 2 - o2 - t2),
              (n2 *= 60))
            : (i2 = f2 > 0 && f2 < 1 ? 0 : n2),
          new s(n2, i2, f2, r2.opacity)
        );
      }
      function Pa(r2, a2, e2, $2) {
        return 1 === arguments.length
          ? _b(r2)
          : new s(r2, a2, e2, null == $2 ? 1 : $2);
      }
        ...
        G(
          ...
          P(x, {
            brighter: function (r2) {
              return (
                (r2 = null == r2 ? H : Math.pow(H, r2)),
                new g(this.r * r2, this.g * r2, this.b * r2, this.opacity)
              );
            },
            darker: function (r2) {
              return (
                (r2 = null == r2 ? t : Math.pow(t, r2)),
                new g(this.r * r2, this.g * r2, this.b * r2, this.opacity)
              );
            },
            rgb: function () {
        ...
        G(
          ...
          P(x, {
            brighter: function (r2) {
              return (
                (r2 = null == r2 ? H : Math.pow(H, r2)),
                new s(this.h, this.s, this.l * r2, this.opacity)
              );
            },
            darker: function (r2) {
              return (
            ...
            rgb: function () {
              var r2 = (this.h % 360) + 360 * (this.h < 0),
                a2 = isNaN(r2) || isNaN(this.s) ? 0 : this.s,
                e2 = this.l,
                $2 = e2 + (e2 < 0.5 ? e2 : 1 - e2) * a2,
                t2 = 2 * e2 - $2;
              return new g(
                Qa(r2 >= 240 ? r2 - 240 : r2 + 120, t2, $2),
                Qa(r2, t2, $2),
                Qa(r2 < 120 ? r2 + 240 : r2 - 120, t2, $2),
                this.opacity
              );
            },
            displayable: function () {
      ...
      var na = 18,
        ...
        df = J * J * J;
      function hc($2) {
        if ($2 instanceof i) return new i($2.l, $2.a, $2.b, $2.opacity);
        if ($2 instanceof n) return ic($2);
        ...
        var r2,
          ...
          a2 = Ua($2.g),
          f2 = Ua($2.b),
          e2 = Ra((0.2225045 * v2 + 0.7168786 * a2 + 0.0606169 * f2) / dc);
        return (
          v2 === a2 && a2 === f2
            ? (r2 = t2 = e2)
            : ((r2 = Ra(
                (0.4360747 * v2 + 0.3850649 * a2 + 0.1430804 * f2) / cc
              )),
              (t2 = Ra(
                (0.0139322 * v2 + 0.0971045 * a2 + 0.7141733 * f2) / ec
              ))),
          new i(116 * e2 - 16, 500 * (r2 - e2), 200 * (e2 - t2), $2.opacity)
        );
      }
      function ef($2, r2, t2, v2) {
        return 1 === arguments.length
          ? hc($2)
          : new i($2, r2, t2, null == v2 ? 1 : v2);
      }
      ...
      function Ta($2) {
        return (
          255 *
          ($2 <= 31308e-7 ? 12.92 * $2 : 1.055 * Math.pow($2, 1 / 2.4) - 0.055)
        );
      }
      function Ua($2) {
        return ($2 /= 255) <= 0.04045
          ? $2 / 12.92
          : Math.pow(($2 + 0.055) / 1.055, 2.4);
      }
      function ff($2) {
        if ($2 instanceof n) return new n($2.h, $2.c, $2.l, $2.opacity);
        if (($2 instanceof i || ($2 = hc($2)), 0 === $2.a && 0 === $2.b))
          return new n(NaN, 0 < $2.l && $2.l < 100 ? 0 : NaN, $2.l, $2.opacity);
        var r2 = Math.atan2($2.b, $2.a) * bc;
        return new n(
          r2 < 0 ? r2 + 360 : r2,
          Math.sqrt($2.a * $2.a + $2.b * $2.b),
          $2.l,
          $2.opacity
        );
      }
      function Va($2, r2, t2, v2) {
        return 1 === arguments.length
          ? ff($2)
          : new n($2, r2, t2, null == v2 ? 1 : v2);
      }
      function n($2, r2, t2, v2) {
        (this.h = +$2), (this.c = +r2), (this.l = +t2), (this.opacity = +v2);
      }
      function ic($2) {
        if (isNaN($2.h)) return new i($2.l, 0, 0, $2.opacity);
        var r2 = $2.h * ac;
        return new i(
          $2.l,
          Math.cos(r2) * $2.c,
      ...
      G(
        ...
        P(x, {
          ...
          rgb: function () {
            var $2 = (this.l + 16) / 116,
              r2 = isNaN(this.a) ? $2 : $2 + this.a / 500,
              t2 = isNaN(this.b) ? $2 : $2 - this.b / 200;
            return (
              (r2 = cc * Sa(r2)),
              ($2 = dc * Sa($2)),
              (t2 = ec * Sa(t2)),
              new g(
                Ta(3.1338561 * r2 - 1.6168667 * $2 - 0.4906146 * t2),
                Ta(-0.9787684 * r2 + 1.9161415 * $2 + 0.033454 * t2),
                Ta(0.0719453 * r2 - 0.2289914 * $2 + 1.4052427 * t2),
                this.opacity
              )
            );
          },
      ...
      var jc = -0.14861,
        ...
        mc = Wa * Xa - oa * jc;
      function gf($2) {
        if ($2 instanceof B) return new B($2.h, $2.s, $2.l, $2.opacity);
        $2 instanceof g || ($2 = Na($2));
        var r2 = $2.r / 255,
          t2 = $2.g / 255,
          e2 = $2.b / 255,
          C2 = (mc * e2 + kc * r2 - lc * t2) / (mc + kc - lc),
          a2 = e2 - C2,
          M2 = (T * (t2 - C2) - Xa * a2) / oa,
          i2 = Math.sqrt(M2 * M2 + a2 * a2) / (T * C2 * (1 - C2)),
          X2 = i2 ? Math.atan2(M2, a2) * bc - 120 : NaN;
        return new B(X2 < 0 ? X2 + 360 : X2, i2, C2, $2.opacity);
      }
      function Ya($2, r2, t2, e2) {
        return 1 === arguments.length
          ? gf($2)
          : new B($2, r2, t2, null == e2 ? 1 : e2);
      }
      ...
      G(
        ...
        P(x, {
          brighter: function ($2) {
            return (
              ($2 = null == $2 ? H : Math.pow(H, $2)),
              new B(this.h, this.s, this.l * $2, this.opacity)
            );
          },
          darker: function ($2) {
            return (
              ($2 = null == $2 ? t : Math.pow(t, $2)),
              new B(this.h, this.s, this.l * $2, this.opacity)
            );
          },
          rgb: function () {
            var $2 = isNaN(this.h) ? 0 : (this.h + 120) * ac,
              r2 = +this.l,
              t2 = isNaN(this.s) ? 0 : this.s * r2 * (1 - r2),
              e2 = Math.cos($2),
              C2 = Math.sin($2);
            return new g(
              255 * (r2 + t2 * (jc * e2 + Wa * C2)),
              255 * (r2 + t2 * (Xa * e2 + oa * C2)),
              255 * (r2 + t2 * (T * e2)),
              this.opacity
            );
          },
      ...
      var hf = function ($2) {
        ...
        return function (t2) {
          var e2 =
            ...
            a2 = $2[e2],
            l2 = $2[e2 + 1],
            o2 = e2 > 0 ? $2[e2 - 1] : 2 * a2 - l2,
            s2 = e2 < r2 - 1 ? $2[e2 + 2] : 2 * l2 - a2;
      ...
      var jf = function (r2) {
        var $2 = r2.length;
        return function (t2) {
          var e2 = Math.floor(((t2 %= 1) < 0 ? ++t2 : t2) * $2),
            n2 = r2[(e2 + $2 - 1) % $2],
            a2 = r2[e2 % $2],
            o2 = r2[(e2 + 1) % $2],
            h2 = r2[(e2 + 2) % $2];
      ...
      function Za($2, t2) {
        var r2 = t2 - $2;
        return r2
          ? oc($2, r2 > 180 || r2 < -180 ? r2 - 360 * Math.round(r2 / 360) : r2)
          : pa(isNaN($2) ? t2 : $2);
      }
      function lf($2) {
        return 1 == ($2 = +$2)
      ...
      var pc = (function r2($2) {
        var o2 = lf($2);
        function e2(r3, $3) {
          var e3 = o2((r3 = ma(r3)).r, ($3 = ma($3)).r),
            a2 = o2(r3.g, $3.g),
            t2 = o2(r3.b, $3.b),
            i2 = j(r3.opacity, $3.opacity);
          return function ($4) {
            return (
              (r3.r = e3($4)),
              (r3.g = a2($4)),
      ...
      var mf = function (r2, e2) {
        var t2,
          $2 = e2 ? e2.length : 0,
          a2 = r2 ? Math.min($2, r2.length) : 0,
          n2 = new Array(a2),
          o2 = new Array($2);
        for (t2 = 0; t2 < a2; ++t2) n2[t2] = ab(r2[t2], e2[t2]);
      ...
      var of = function (e2, r2) {
        var t2,
          $2 = {},
          i2 = {};
        for (t2 in ((null !== e2 && "object" == typeof e2) || (e2 = {}),
        (null !== r2 && "object" == typeof r2) || (r2 = {}),
        r2))
      ...
      var rf = function (r2, $2) {
        ...
        for (r2 += "", $2 += ""; (n2 = $a.exec(r2)) && (e2 = _a.exec($2)); )
          (t2 = e2.index) > a2 &&
            ((t2 = $2.slice(a2, t2)),
            E2[u2] ? (E2[u2] += t2) : (E2[++u2] = t2)),
            (n2 = n2[0]) === (e2 = e2[0])
              ? E2[u2]
                ? (E2[u2] += e2)
                : (E2[++u2] = e2)
              : ((E2[++u2] = null), o2.push({ i: u2, x: v(n2, e2) })),
            (a2 = _a.lastIndex);
        return (
          a2 < $2.length &&
            ((t2 = $2.slice(a2)), E2[u2] ? (E2[u2] += t2) : (E2[++u2] = t2)),
          E2.length < 2
            ? o2[0]
              ? qf(o2[0].x)
              : pf($2)
      ...
      var ab = function (r2, $2) {
        ...
        return null == $2 || "boolean" === c2
          ...
          : ("number" === c2
              ...
              : Array.isArray($2)
              ? mf
              : ("function" != typeof $2.valueOf &&
                  "function" != typeof $2.toString) ||
                isNaN($2)
              ? of
              : v)(r2, $2);
      };
        ...
        return function (a2, $2) {
          ...
          return (
            ...
            (function (r3, l3, n3, a3, $3, s3) {
              ...
              } else (n3 || a3) && $3.push("translate(" + n3 + e2 + a3 + t2);
            })(
              a2.translateX,
              a2.translateY,
              $2.translateX,
            ...
            (function (r3, e3, t3, a3) {
              r3 !== e3
                ? (r3 - e3 > 180 ? (e3 += 360) : e3 - r3 > 180 && (r3 += 360),
                  a3.push({
                    i: t3.push(n2(t3) + "rotate(", null, l2) - 2,
                    x: v(r3, e3),
                  }))
                : e3 && t3.push(n2(t3) + "rotate(" + e3 + l2);
            })(a2.rotate, $2.rotate, s2, o2),
            (function (r3, e3, t3, a3) {
              r3 !== e3
                ? a3.push({
                    i: t3.push(n2(t3) + "skewX(", null, l2) - 2,
                    x: v(r3, e3),
                  })
                : e3 && t3.push(n2(t3) + "skewX(" + e3 + l2);
            })(a2.skewX, $2.skewX, s2, o2),
            (function (r3, e3, t3, l3, a3, $3) {
              if (r3 !== t3 || e3 !== l3) {
                ...
                (1 === t3 && 1 === l3) ||
                  a3.push(n2(a3) + "scale(" + t3 + "," + l3 + ")");
            })(a2.scaleX, a2.scaleY, $2.scaleX, $2.scaleY, s2, o2),
            (a2 = $2 = null),
            function (r3) {
      ...
      function uf($2) {
        return "none" === $2
          ...
          : (qa ||
              ...
              (tf = document.defaultView)),
            (qa.style.transform = $2),
            ($2 = tf
              .getComputedStyle(sc.appendChild(qa), null)
              .getPropertyValue("transform")),
            sc.removeChild(qa),
            ($2 = $2.slice(7, -1).split(",")),
            uc(+$2[0], +$2[1], +$2[2], +$2[3], +$2[4], +$2[5]));
      }
      function vf($2) {
        return null == $2
          ? cb
          : (bb ||
              (bb = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "g"
              )),
            bb.setAttribute("transform", $2),
            ($2 = bb.transform.baseVal.consolidate())
              ? (($2 = $2.matrix), uc($2.a, $2.b, $2.c, $2.d, $2.e, $2.f))
              : cb);
      }
      var tc = 180 / Math.PI,
        cb = {
      ...
      var uc = function (t2, e2, a2, $2, r2, s2) {
        var X2, n2, w2;
        return (
          (X2 = Math.sqrt(t2 * t2 + e2 * e2)) && ((t2 /= X2), (e2 /= X2)),
          (w2 = t2 * a2 + e2 * $2) && ((a2 -= t2 * w2), ($2 -= e2 * w2)),
          (n2 = Math.sqrt(a2 * a2 + $2 * $2)) &&
            ((a2 /= n2), ($2 /= n2), (w2 /= n2)),
          t2 * $2 < e2 * a2 && ((t2 = -t2), (e2 = -e2), (w2 = -w2), (X2 = -X2)),
          {
            translateX: r2,
            translateY: s2,
            rotate: Math.atan2(e2, t2) * tc,
            skewX: Math.atan(w2) * tc,
            scaleX: X2,
            scaleY: n2,
          }
        );
      ...
      function vc($2) {
        return function (r2, e2) {
          var o2 = $2((r2 = Pa(r2)).h, (e2 = Pa(e2)).h),
            t2 = j(r2.s, e2.s),
            l2 = j(r2.l, e2.l),
            d2 = j(r2.opacity, e2.opacity);
          return function ($3) {
            return (
              (r2.h = o2($3)),
              (r2.s = t2($3)),
      ...
      function wc($2) {
        return function (r2, o2) {
          var c2 = $2((r2 = Va(r2)).h, (o2 = Va(o2)).h),
            t2 = j(r2.c, o2.c),
            x2 = j(r2.l, o2.l),
            l2 = j(r2.opacity, o2.opacity);
          return function ($3) {
            return (
              (r2.h = c2($3)),
              (r2.c = t2($3)),
      ...
      function xc($2) {
        return (function r2(o2) {
          function V2(r3, V3) {
            var e2 = $2((r3 = Ya(r3)).h, (V3 = Ya(V3)).h),
              t2 = j(r3.s, V3.s),
              i2 = j(r3.l, V3.l),
              l2 = j(r3.opacity, V3.opacity);
            return function ($3) {
              return (
                (r3.h = e2($3)),
                (r3.s = t2($3)),
                (r3.l = i2(Math.pow($3, o2))),
                (r3.opacity = l2($3)),
                r3 + ""
              );
            };
      ...
      function yf(r2, n2, t2) {
        ...
        return (
          $2 < e2
            ? ((e2 = db($2, e2)), (a2 = t2(o2, a2)))
            : ((e2 = db(e2, $2)), (a2 = t2(a2, o2))),
          function (r3) {
            return a2(e2(r3));
          }
        );
      ...
      function zf(r2, n2, t2) {
        var e2 = Math.min(r2.length, n2.length) - 1,
          $2 = new Array(e2),
          a2 = new Array(e2),
          o2 = -1;
        for (
          r2[e2] < r2[0] &&
          ((r2 = r2.slice().reverse()), (n2 = n2.slice().reverse()));
          ++o2 < e2;
      ...
      function Af() {
        ...
        function l2() {
          return (
            (e2 = Math.min(o2.length, i2.length) > 2 ? zf : yf),
            ($2 = a2 = null),
            c2
          );
        }
        function c2(n3) {
          return isNaN((n3 = +n3))
            ? t2
            : ($2 || ($2 = e2(o2.map(r2), i2, u2)))(r2(p2(n3)));
        }
        return (
          (c2.invert = function (t3) {
            return p2(n2((a2 || (a2 = e2(i2, o2.map(r2), v)))(t3)));
          }),
          (c2.domain = function (r3) {
            return arguments.length
              ? ((o2 = Array.from(r3, xf)), p2 === z || (p2 = zc(o2)), l2())
              : o2.slice();
          }),
      ...
      var ra = function (e2, t2) {
        if (
          (l2 = (e2 = t2
            ? e2.toExponential(t2 - 1)
            : e2.toExponential()).indexOf("e")) < 0
        )
          return null;
        var l2,
          n2 = e2.slice(0, l2);
      ...
      var Ef = function (r2, t2) {
        return function (e2, n2) {
          for (
            var $2 = e2.length, u2 = [], o2 = 0, a2 = r2[0], f2 = 0;
            $2 > 0 &&
            a2 > 0 &&
            (f2 + a2 + 1 > n2 && (a2 = Math.max(1, n2 - f2)),
            u2.push(e2.substring(($2 -= a2), $2 + a2)),
            !((f2 += a2 + 1) > n2));
      ...
      function fb(i2) {
        if (!(t2 = Gf.exec(i2))) throw new Error("invalid format: " + i2);
        var t2;
        (this.fill = t2[1] || " "),
          (this.align = t2[2] || ">"),
          (this.sign = t2[3] || "-"),
          (this.symbol = t2[4] || ""),
          (this.zero = !!t2[5]),
          (this.width = t2[6] && +t2[6]),
          (this.comma = !!t2[7]),
          (this.precision = t2[8] && +t2[8].slice(1)),
          (this.trim = !!t2[9]),
          (this.type = t2[10] || "");
      }
      (sa.prototype = fb.prototype),
      ...
      var Hf = function (e2) {
        e: for (var r2, t2 = e2.length, a2 = 1, $2 = -1; a2 < t2; ++a2)
          switch (e2[a2]) {
            case ".":
              $2 = r2 = a2;
              break;
      ...
      var Jf = function (e2, p2) {
        ...
        var $2 = a2[0],
          ...
          f2 =
            t2 -
            ((r2 = If = 3 * Math.max(-8, Math.min(8, Math.floor(t2 / 3)))),
            r2) +
            1,
          o2 = $2.length;
        return f2 === o2
          ? $2
          : f2 > o2
          ? $2 + new Array(f2 - o2 + 1).join("0")
          : f2 > 0
          ? $2.slice(0, f2) + "." + $2.slice(f2)
          : "0." +
            new Array(1 - f2).join("0") +
            ra(e2, Math.max(0, p2 + f2 - 1))[0];
      };
      var Cc = function (r2, e2) {
        ...
        var $2 = t2[0],
          a2 = t2[1];
        return a2 < 0
          ? "0." + new Array(-a2).join("0") + $2
          : $2.length > a2 + 1
          ? $2.slice(0, a2 + 1) + "." + $2.slice(a2 + 1)
          : $2 + new Array(a2 - $2.length + 2).join("0");
      };
      var Dc = {
        "%": function (t2, r2) {
      ...
      var Fc = [
        ...
        Kf = function (r2) {
          var e2 =
              r2.grouping && r2.thousands ? Ef(r2.grouping, r2.thousands) : Ec,
            t2 = r2.currency,
            a2 = r2.decimal,
            m2 = r2.numerals ? Ff(r2.numerals) : Ec,
            $2 = r2.percent || "%";
          function i2(r3) {
            var i3 = (r3 = sa(r3)).fill,
              o2 = r3.align,
              n2 = r3.sign,
              p2 = r3.symbol,
              f2 = r3.zero,
            ...
            "n" === c2
              ? ((s2 = true), (c2 = "g"))
              : Dc[c2] || (null == u2 && (u2 = 12), (M2 = true), (c2 = "g")),
              (f2 || ("0" === i3 && "=" === o2)) &&
                ((f2 = true), (i3 = "0"), (o2 = "="));
            var I2 =
                "$" === p2
            ...
            function x2(r4) {
              var t3,
                ...
                x3 = I2,
                d2 = V2;
              if ("c" === c2) (d2 = h2(r4) + d2), (r4 = "");
              else {
                var v2 = (r4 = +r4) < 0;
                if (
                  ((r4 = h2(Math.abs(r4), u2)),
                  M2 && (r4 = Hf(r4)),
                  v2 && 0 == +r4 && (v2 = false),
                  (x3 =
                    (v2
                  ...
                  for (t3 = -1, $3 = r4.length; ++t3 < $3; )
                    if (48 > (p3 = r4.charCodeAt(t3)) || p3 > 57) {
                      (d2 =
                        (46 === p3 ? a2 + r4.slice(t3 + 1) : r4.slice(t3)) +
                        d2),
                        (r4 = r4.slice(0, t3));
                      break;
                    }
              ...
              s2 && !f2 && (r4 = e2(r4, 1 / 0));
              var y2 = x3.length + r4.length + d2.length,
                q2 = y2 < l2 ? new Array(l2 - y2 + 1).join(i3) : "";
              switch (
                (s2 &&
                  f2 &&
                  ((r4 = e2(q2 + r4, q2.length ? l2 - d2.length : 1 / 0)),
                  (q2 = "")),
                o2)
              ) {
                case "<":
            ...
            return (
              (u2 =
                null == u2
                  ? 6
                  : /[gprs]/.test(c2)
                  ? Math.max(1, Math.min(21, u2))
                  : Math.max(0, Math.min(20, u2))),
          ...
          return {
            format: i2,
            formatPrefix: function (r3, e3) {
              var t3 = i2((((r3 = sa(r3)).type = "f"), r3)),
                a3 = 3 * Math.max(-8, Math.min(8, Math.floor(K(e3) / 3))),
                m3 = Math.pow(10, -a3),
                $3 = Fc[8 + a3 / 3];
              return function (r4) {
                return t3(m3 * r4) + $3;
      ...
      var Mf = function (t2, $2) {
        return Math.max(
          0,
          3 * Math.max(-8, Math.min(8, Math.floor(K($2) / 3))) - K(Math.abs(t2))
        );
      };
      ...
      var Of = function (a2, r2, e2, i2) {
        ...
        switch ((i2 = sa(null == i2 ? ",f" : i2)).type) {
          ...
          case "r":
            null != i2.precision ||
              isNaN(($2 = Nf(t2, Math.max(Math.abs(a2), Math.abs(r2))))) ||
              (i2.precision = $2 - ("e" === i2.type));
            break;
          case "f":
          case "%":
            null != i2.precision ||
              isNaN(($2 = Lf(t2))) ||
              (i2.precision = $2 - 2 * ("%" === i2.type));
        }
        return Bf(i2);
      };
      ...
      function Hc(t2, r2) {
        ...
        function u2(u3) {
          var M2 =
            ...
            F2 =
              null == e2
                ? r2.tickFormat
                  ? r2.tickFormat.apply(r2, $2)
                  : Pf
                : e2,
            f2 = Math.max(a2, 0) + c2,
            p2 = r2.range(),
            v2 = +p2[0] + 0.5,
            x2 = +p2[p2.length - 1] + 0.5,
            m2 = (r2.bandwidth ? Tf : Sf)(r2.copy()),
            h2 = u3.selection ? u3.selection() : u3,
            g2 = h2.selectAll(".domain").data([null]),
            d2 = h2.selectAll(".tick").data(M2, r2).order(),
            k2 = d2.exit(),
            y2 = d2.enter().append("g").attr("class", "tick"),
            b2 = d2.select("line"),
            _2 = d2.select("text");
          (g2 = g2.merge(
            g2
            ...
            (_2 = _2.merge(
              y2
                ...
                .attr(l2, o2 * f2)
                .attr("dy", t2 === hb ? "0em" : t2 === jb ? "0.71em" : "0.32em")
            )),
            u3 !== h2 &&
              ((g2 = g2.transition(u3)),
              (d2 = d2.transition(u3)),
              ...
              (k2 = k2
                .transition(u3)
                .attr("opacity", Gc)
                .attr("transform", function (t3) {
                  return isFinite((t3 = m2(t3)))
                    ? s2(t3)
            ...
            g2.attr(
              ...
              t2 === Y || t2 == ib
                ? i2
                  ? "M" + o2 * i2 + "," + v2 + "H0.5V" + x2 + "H" + o2 * i2
                  : "M0.5," + v2 + "V" + x2
                : i2
                ? "M" + v2 + "," + o2 * i2 + "V0.5H" + x2 + "V" + o2 * i2
                : "M" + v2 + ",0.5H" + x2
            ),
            d2.attr("opacity", 1).attr("transform", function (t3) {
              return s2(m2(t3));
            }),
            b2.attr(l2 + "2", o2 * a2),
            _2.attr(l2, o2 * f2).text(F2),
            h2
              .filter(Uf)
              .attr("fill", "none")
              .attr("font-size", 10)
        ...
        return (
          ...
          (u2.tickArguments = function (t3) {
            return arguments.length
              ? (($2 = null == t3 ? [] : gb.call(t3)), u2)
              : $2.slice();
          }),
          (u2.tickValues = function (t3) {
            return arguments.length
              ? ((n2 = null == t3 ? null : gb.call(t3)), u2)
              : n2 && n2.slice();
          }),
      ...
      const Xf = (
          ...
          t2
            .append("g")
            .call(Wf(l2).tickSize(1).tickPadding(10).ticks(e2, "s")),
            t2
              .selectAll(".domain")
              .attr("filter", s2 ? null : "url(#xkcdify)")
              .style("stroke", a2),
            t2
              .selectAll(".tick > text")
              .style("font-family", i2)
              .style("font-size", "16")
              .style("fill", a2);
        },
        Yf = (
          ...
          t2
            .append("g")
            .attr("transform", `translate(0,${i2})`)
            .call(Vf(l2).tickSize(0).tickPadding(6).ticks(e2)),
            t2
              .selectAll(".domain")
              .attr("filter", a2 ? null : "url(#xkcdify)")
              .style("stroke", $2),
            t2
              .selectAll(".tick > text")
              .style("font-family", s2)
              .style("font-size", "16")
              .style("fill", $2);
        };
      ...
      const b = {
        positionType: { upLeft: 1, upRight: 2, downLeft: 3, downRight: 4 },
      };
      class L {
        constructor({
          parent: t2,
          ...
          (this.title = i2),
            (this.items = e2),
            (this.position = s2),
            (this.filter = r2 ? null : "url(#xkcdify)"),
            (this.backgroundColor = o2),
            (this.strokeColor = h2),
            (this.svg = t2
              .append("svg")
        ...
        update({ title: t2, items: i2, position: e2 }) {
          if (
            (t2 &&
              t2 !== this.title &&
              ((this.title = t2), this.tipTitle.text(t2)),
            i2 && JSON.stringify(i2) !== JSON.stringify(this.items))
          ) {
            (this.items = i2),
              this.tipItems.forEach((t4) => t4.svg.remove()),
              (this.tipItems = this.items.map((t4, i3) => {
                return this._generateTipItem(t4, i3);
              }));
            const t3 = Math.max(
              ...this.tipItems.map((t4) => t4.width),
        ...
        _getBackgroundWidth() {
          const t2 = this.items.reduce(
            (t3, i2) => (t3 > i2.text.length ? t3 : i2.text.length),
            0
          );
        ...
        _getUpLeftX() {
          return this.position.type === b.positionType.upRight ||
            this.position.type === b.positionType.downRight
            ? this.position.x
            : this.position.x - this._getBackgroundWidth() - 20;
        }
        _getUpLeftY() {
          return this.position.type === b.positionType.downLeft ||
            this.position.type === b.positionType.downRight
            ? this.position.y
            : this.position.y - this._getBackgroundHeight() - 20;
        }
      }
      function M(A2) {
        A2.append("defs").append("style").attr("type", "text/css")
          .text(`@font-face {
      font-family: "xkcd";
      ...
      class ag {
        constructor(
          ...
          (this.options = od(
            ...
            e2 && ((this.title = e2), (l.top = 60)),
            i2 && ((this.xLabel = i2), (l.bottom = 50)),
            o2 && ((this.yLabel = o2), (l.left = 70)),
            (this.data = { labels: r2, datasets: s2 }),
            (this.filter = "url(#xkcdify)"),
            (this.fontFamily = this.options.fontFamily || "xkcd"),
            this.options.unxkcdify &&
              ((this.filter = null),
              (this.fontFamily =
            ...
            (this.svgEl = f(t2)
              ...
              .attr("width", t2.parentElement.clientWidth)
              .attr(
                "height",
                Math.min(
                  (2 * t2.parentElement.clientWidth) / 3,
                  window.innerHeight
                )
              )),
            ...
            (this.width = this.svgEl.attr("width") - l.left - l.right),
            (this.height = this.svgEl.attr("height") - l.top - l.bottom),
            M(this.svgEl),
            N(this.svgEl),
            this.render();
        }
        render() {
          this.title &&
            k.title(this.svgEl, this.title, this.options.strokeColor),
            this.xLabel &&
              k.xLabel(this.svgEl, this.xLabel, this.options.strokeColor),
            this.yLabel &&
              k.yLabel(this.svgEl, this.yLabel, this.options.strokeColor);
          const t2 = new L({
              parent: this.svgEl,
              title: "tooltip",
              items: [
              ...
              position: { x: 30, y: 30, type: b.positionType.upRight },
            ...
            e2 = ja()
              ...
              .padding(0.4),
            i2 = this.data.datasets.reduce((t3, e3) => t3.concat(e3.data), []),
            o2 = A()
              .domain([0, Math.max(...i2)])
              .range([this.height, 0]),
            r2 = this.chart.append("g");
          y.xAxis(r2, {
            xScale: e2,
            tickCount: 3,
            ...
            r2
              ...
              .attr("x", (t3, i3) => e2(this.data.labels[i3]))
              .attr("width", e2.bandwidth())
              .attr("y", (t3) => o2(t3))
              .attr("height", (t3) => this.height - o2(t3))
              .attr("fill", "none")
              ...
              .on("mousemove", (e3, i3, o3) => {
                const r3 = w(o3[i3])[0] + l.left + 10,
                  s2 = w(o3[i3])[1] + l.top + 10;
                let a2 = b.positionType.downRight;
                r3 > this.width / 2 && s2 < this.height / 2
                  ? (a2 = b.positionType.downLeft)
                  : r3 > this.width / 2 && s2 > this.height / 2
                  ? (a2 = b.positionType.upLeft)
                  : r3 < this.width / 2 &&
                    s2 > this.height / 2 &&
                    (a2 = b.positionType.upRight),
                  t2.update({
                    title: this.data.labels[i3],
                    items: [
                      {
                        color: this.options.dataColors[i3],
                        text: `${this.data.datasets[0].label || ""}: ${e3}`,
                      },
                    ],
                    position: { x: r3, y: s2, type: a2 },
                  });
              });
        }
        update() {}
      ...
      function bg(t2) {
        for (var o2 = 1; o2 < arguments.length; o2++) {
          ...
          o2 % 2
            ? Ic(e2, true).forEach(function (o3) {
                cg(t2, o3, e2[o3]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(e2))
            : Ic(e2).forEach(function (o3) {
                Object.defineProperty(
                  t2,
                  o3,
                  Object.getOwnPropertyDescriptor(e2, o3)
                );
              });
        }
        return t2;
      ...
      function Z(
        ...
        const f2 = s2.node().getBBox(),
          c2 = f2.width + 15,
          g2 = f2.height + 10;
        let y2 = 0,
          h2 = 0;
        (e2 !== b.positionType.downLeft && e2 !== b.positionType.downRight) ||
          (h2 = a2 - g2 - 13),
          (e2 !== b.positionType.upRight && e2 !== b.positionType.downRight) ||
            (y2 = o2 - c2 - 13),
          d2
            .append("rect")
            .style("fill", n2)
          ...
          (this.options = bg(
            {
              ...
              strokeColor: "black",
              backgroundColor: "white",
              legendPosition: b.positionType.upLeft,
              showLegend: true,
            },
            a2
          )),
            o2 && ((this.title = o2), (p.top = 60)),
            e2 && ((this.xLabel = e2), (p.bottom = 50)),
            i2 && ((this.yLabel = i2), (p.left = 70)),
            (this.data = { labels: r2, datasets: s2 }),
            (this.filter = "url(#xkcdify)"),
            (this.fontFamily = this.options.fontFamily || "xkcd"),
            this.options.unxkcdify &&
            ...
            (this.width = this.svgEl.attr("width") - p.left - p.right),
            (this.height = this.svgEl.attr("height") - p.top - p.bottom),
            M(this.svgEl),
            N(this.svgEl),
            this.render();
        }
        render() {
          ...
          const t2 = new L({
            ...
            o2 = ja()
              ...
              .domain(this.data.labels)
              .padding(0.4),
            e2 = this.data.datasets.reduce(
              (t3, o3) => o3.data.map((o4, e3) => (t3[e3] || 0) + o4),
              []
            ),
            i2 = A()
              .domain([0, Math.max(...e2)])
              .range([this.height, 0]),
            r2 = this.chart.append("g");
          y.xAxis(r2, {
            xScale: o2,
          ...
          const s2 = this.data.datasets.reduce(
              (t3, o3) => t3.concat(o3.data),
              []
            ),
            a2 = this.data.datasets[0].data.length,
            n2 = this.data.datasets
              .reduce(
                (t3, o3, e3) => (
                  e3 > 0
                    ? t3.push(
                        o3.data.map(
                          (o4, i3) =>
                            this.data.datasets[e3 - 1].data[i3] + t3[e3 - 1][i3]
                        )
                      )
                    : t3.push(new Array(o3.data.length).fill(0)),
                  t3
                ),
                []
              )
          ...
          if (
            (r2
              .selectAll(".xkcd-chart-stacked-bar")
              .data(s2)
              .enter()
              .append("rect")
              .attr("class", "xkcd-chart-stacked-bar")
              .attr("x", (t3, e3) => o2(this.data.labels[e3 % a2]))
              .attr("width", o2.bandwidth())
              .attr("y", (t3, o3) => i2(t3 + n2[o3]))
              .attr("height", (t3) => this.height - i2(t3))
              .attr(
                "fill",
                (t3, o3) => this.options.dataColors[Math.floor(o3 / a2)]
              )
              .attr("pointer-events", "all")
              .attr("stroke", this.options.strokeColor)
              .attr("stroke-width", 3)
              .attr("rx", 2)
              .attr("filter", this.filter)
              .on("mouseover", () => t2.show())
              .on("mouseout", () => t2.hide())
              .on("mousemove", (o3, e3, i3) => {
                const r3 = w(i3[e3])[0] + p.left + 10,
                  s3 = w(i3[e3])[1] + p.top + 10,
                  n3 = this.data.datasets
                    .map((t3, o4) => ({
                      color: this.options.dataColors[o4],
                      text: `${this.data.datasets[o4].label || ""}: ${
                        this.data.datasets[o4].data[e3 % a2]
                      }`,
                    }))
                    .reverse();
                let l2 = b.positionType.downRight;
                r3 > this.width / 2 && s3 < this.height / 2
                  ? (l2 = b.positionType.downLeft)
                  : r3 > this.width / 2 && s3 > this.height / 2
                  ? (l2 = b.positionType.upLeft)
                  : r3 < this.width / 2 &&
                    s3 > this.height / 2 &&
                    (l2 = b.positionType.upRight),
                  t2.update({
                    title: this.data.labels[e3],
                    items: n3,
                    position: { x: r3, y: s3, type: l2 },
                  });
              }),
            this.options.showLegend)
          ) {
            const t3 = this.data.datasets
              .map((t4, o3) => ({
                color: this.options.dataColors[o3],
                text: `${this.data.datasets[o3].label || ""}`,
              }))
              .reverse();
            Z(r2, {
              items: t3,
      ...
      function eg(t2) {
        for (var e2 = 1; e2 < arguments.length; e2++) {
          var i2 = null != arguments[e2] ? arguments[e2] : {};
          e2 % 2
            ? Jc(i2, true).forEach(function (e3) {
                fg(t2, e3, i2[e3]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(i2))
            : Jc(i2).forEach(function (e3) {
                Object.defineProperty(
                  t2,
                  e3,
                  Object.getOwnPropertyDescriptor(i2, e3)
      ...
      var kg = function () {
        ...
        function a2(a3) {
          var i2,
            ...
            s2 = new Array(A2),
            b2 = new Array(A2),
            U2 = +e2.apply(this, arguments),
            Z2 = Math.min(ua, Math.max(-ua, $2.apply(this, arguments) - U2)),
            m2 = Math.min(Math.abs(Z2) / A2, o2.apply(this, arguments)),
            d2 = m2 * (Z2 < 0 ? -1 : 1);
          for (i2 = 0; i2 < A2; ++i2)
            (c2 = b2[(s2[i2] = i2)] = +t2(a3[i2], i2, a3)) > 0 && (f2 += c2);
          for (
            null != n2
              ? s2.sort(function (t3, r3) {
                  return n2(b2[t3], b2[r3]);
                })
              : null != r2 &&
                s2.sort(function (t3, n3) {
        ...
        return (
          (a2.value = function (n3) {
            return arguments.length
              ? ((t2 = "function" == typeof n3 ? n3 : c(+n3)), a2)
              : t2;
          }),
          ...
          (a2.startAngle = function (t3) {
            return arguments.length
              ? ((e2 = "function" == typeof t3 ? t3 : c(+t3)), a2)
              : e2;
          }),
          (a2.endAngle = function (t3) {
            return arguments.length
              ? (($2 = "function" == typeof t3 ? t3 : c(+t3)), a2)
              : $2;
          }),
          (a2.padAngle = function (t3) {
            return arguments.length
              ? ((o2 = "function" == typeof t3 ? t3 : c(+t3)), a2)
              : o2;
          }),
          a2
        );
      ...
      function va($2, t2, r2, n2, i2, o2, a2) {
        var p2 = $2 - r2,
          ...
          g2 = i2 - o2,
          h2 = L2 * l2 - s2 * m2,
          d2 = (x2 < 0 ? -1 : 1) * X(ig(0, g2 * g2 * v2 - h2 * h2)),
          T2 = (h2 * x2 - f2 * d2) / v2,
          A2 = (-h2 * f2 - x2 * d2) / v2,
          R2 = (h2 * x2 + f2 * d2) / v2,
          q2 = (-h2 * f2 + x2 * d2) / v2,
          ...
          O2 = q2 - y2;
        return (
          P2 * P2 + b2 * b2 > E2 * E2 + O2 * O2 && ((T2 = R2), (A2 = q2)),
          {
            cx: T2,
            cy: A2,
            x01: -I2,
      ...
      nb.prototype = ob.prototype = {
        constructor: nb,
        moveTo: function (t2, h2) {
          this._ +=
            "M" +
            (this._x0 = this._x1 = +t2) +
            "," +
            (this._y0 = this._y1 = +h2);
        },
        closePath: function () {
          null !== this._x1 &&
            ...
            if (Math.abs(M2 * r2 - _2 * n2) > C && $2) {
              var u2 = i2 - o2,
                ...
                c2 =
                  $2 *
                  Math.tan(
                    (lb - Math.acos((v2 + e2 - l2) / (2 * x2 * p2))) / 2
                  ),
                f2 = c2 / p2,
                y2 = c2 / x2;
              Math.abs(f2 - 1) > C &&
                (this._ += "L" + (t2 + f2 * n2) + "," + (h2 + f2 * M2)),
                (this._ +=
                  "A" +
                  $2 +
                  "," +
        ...
        arc: function (t2, h2, i2, s2, $2, o2) {
          ...
          null === this._x1
            ? (this._ += "M" + _2 + "," + n2)
            : (Math.abs(this._x1 - _2) > C || Math.abs(this._y1 - n2) > C) &&
              (this._ += "L" + _2 + "," + n2),
            i2 &&
              (e2 < 0 && (e2 = (e2 % mb) + mb),
              e2 > rg
                ...
                : e2 > C &&
                  (this._ +=
                    ...
                    M2 +
                    "," +
                    (this._x1 = t2 + i2 * Math.cos($2)) +
                    "," +
                    (this._y1 = h2 + i2 * Math.sin($2))));
        },
      ...
      var sg = function () {
        ...
        function e2() {
          var e3,
            c2,
            I2 = +$2.apply(this, arguments),
            B2 = +t2.apply(this, arguments),
            L2 = i2.apply(this, arguments) - ta,
            m2 = o2.apply(this, arguments) - ta,
            s2 = Kc(m2 - L2),
            l2 = m2 > L2;
          if (
            (p2 || (p2 = e3 = ob()),
            B2 < I2 && ((c2 = B2), (B2 = I2), (I2 = c2)),
            B2 > U)
          ) {
            if (s2 > ua - U)
              p2.moveTo(B2 * W(L2), B2 * V(L2)),
                p2.arc(0, 0, B2, L2, m2, !l2),
                I2 > U &&
                  (p2.moveTo(I2 * W(m2), I2 * V(m2)),
                  p2.arc(0, 0, I2, m2, L2, l2));
            else {
              var u2,
                y2,
                f2 = L2,
                ...
                h2 = s2,
                d2 = s2,
                T2 = a2.apply(this, arguments) / 2,
                A2 =
                  T2 > U &&
                  (n2 ? +n2.apply(this, arguments) : X(I2 * I2 + B2 * B2)),
                R2 = kb(Kc(B2 - I2) / 2, +r2.apply(this, arguments)),
                q2 = R2,
                P2 = R2;
              if (A2 > U) {
                var b2 = Lc((A2 / I2) * V(T2)),
                  E2 = Lc((A2 / B2) * V(T2));
                (h2 -= 2 * b2) > U
                  ? ((v2 += b2 *= l2 ? 1 : -1), (g2 -= b2))
                  : ((h2 = 0), (v2 = g2 = (L2 + m2) / 2)),
                  ...
                  var G2 = O2 - w2[0],
                    ...
                    M2 =
                      ...
                      V(
                        jg(
                          (G2 * J2 + H2 * K2) /
                            (X(G2 * G2 + H2 * H2) * X(J2 * J2 + K2 * K2))
                        ) / 2
                      ),
                    N2 = X(w2[0] * w2[0] + w2[1] * w2[1]);
                  (q2 = kb(R2, (I2 - N2) / (M2 - 1))),
                    (P2 = kb(R2, (B2 - N2) / (M2 + 1)));
                }
              }
              d2 > U
                ? P2 > U
                  ? ((u2 = va(D2, F2, O2, S2, B2, P2, l2)),
                    (y2 = va(z2, C2, j2, k2, B2, P2, l2)),
                    p2.moveTo(u2.cx + u2.x01, u2.cy + u2.y01),
                    P2 < R2
                      ? p2.arc(
                          u2.cx,
                          u2.cy,
                      ...
                      : (p2.arc(
                        ...
                        p2.arc(
                          ...
                          0,
                          B2,
                          Q(u2.cy + u2.y11, u2.cx + u2.x11),
                          Q(y2.cy + y2.y11, y2.cx + y2.x11),
                          !l2
                        ),
                        p2.arc(
                          y2.cx,
                  ...
                  : (p2.moveTo(O2, S2), p2.arc(0, 0, B2, f2, x2, !l2))
                : p2.moveTo(O2, S2),
                I2 > U && h2 > U
                  ? q2 > U
                    ? ((u2 = va(j2, k2, z2, C2, I2, -q2, l2)),
                      (y2 = va(O2, S2, D2, F2, I2, -q2, l2)),
                      p2.lineTo(u2.cx + u2.x01, u2.cy + u2.y01),
                      q2 < R2
                        ? p2.arc(
                            u2.cx,
                            u2.cy,
        ...
        return (
          (e2.centroid = function () {
            var r3 =
                (+$2.apply(this, arguments) + +t2.apply(this, arguments)) / 2,
              n3 =
                (+i2.apply(this, arguments) + +o2.apply(this, arguments)) / 2 -
                _ / 2;
            return [W(n3) * r3, V(n3) * r3];
          }),
          (e2.innerRadius = function (t3) {
            return arguments.length
              ? (($2 = "function" == typeof t3 ? t3 : c(+t3)), e2)
              : $2;
          }),
          (e2.outerRadius = function ($3) {
            return arguments.length
              ? ((t2 = "function" == typeof $3 ? $3 : c(+$3)), e2)
              : t2;
          }),
          (e2.cornerRadius = function ($3) {
            return arguments.length
              ? ((r2 = "function" == typeof $3 ? $3 : c(+$3)), e2)
              : r2;
          }),
          (e2.padRadius = function ($3) {
            return arguments.length
              ? ((n2 =
                  null == $3 ? null : "function" == typeof $3 ? $3 : c(+$3)),
                e2)
              : n2;
          }),
          (e2.startAngle = function ($3) {
            return arguments.length
              ? ((i2 = "function" == typeof $3 ? $3 : c(+$3)), e2)
              : i2;
          }),
          (e2.endAngle = function ($3) {
            return arguments.length
              ? ((o2 = "function" == typeof $3 ? $3 : c(+$3)), e2)
              : o2;
          }),
          (e2.padAngle = function ($3) {
            return arguments.length
              ? ((a2 = "function" == typeof $3 ? $3 : c(+$3)), e2)
              : a2;
          }),
      ...
      class ug {
        constructor(
          t2,
          { title: e2, data: { labels: i2, datasets: o2 }, options: r2 }
        ) {
          (this.options = eg(
            {
              unxkcdify: false,
            ...
            (this.title = e2),
            (this.data = { labels: i2, datasets: o2 }),
        ...
        render() {
          ...
          const t2 = new L({
            ...
            e2 = Math.min(this.width, this.height) / 2 - tg,
            i2 = kg()(this.data.datasets[0].data),
            o2 = sg()
              .innerRadius(
                e2 *
                  (void 0 === this.options.innerRadius
                    ? 0.5
                    : this.options.innerRadius)
              )
              .outerRadius(e2);
          this.chart
            .selectAll(".xkcd-chart-arc")
            .data(i2)
            .enter()
            .append("path")
            ...
            .attr("stroke", this.options.strokeColor)
            .attr("stroke-width", 2)
            .attr("fill", (t3, e3) => this.options.dataColors[e3])
            .attr("filter", this.filter)
            .on("mouseover", (e3, i3, o3) => {
            ...
            .on("mousemove", (e3, i3, o3) => {
              const r3 = w(o3[i3])[0] + this.width / 2 + 10,
                s3 = w(o3[i3])[1] + this.height / 2 + 10;
              t2.update({
                title: this.data.labels[i3],
                items: [
                  {
                    color: this.options.dataColors[i3],
                    text: `${this.data.datasets[0].label || ""}: ${e3.data}`,
                  },
                ],
                position: { x: r3, y: s3, type: b.positionType.downRight },
              });
            });
          const r2 = this.data.datasets[0].data.map((t3, e3) => ({
              color: this.options.dataColors[e3],
              text: this.data.labels[e3],
            })),
            s2 = this.svgEl.append("g").attr("transform", "translate(0, 30)");
          this.options.showLegend &&
            Z(s2, {
              items: r2,
              position: this.options.legendPosition,
      ...
      function vg(t2) {
        for (var i2 = 1; i2 < arguments.length; i2++) {
          ...
          i2 % 2
            ? Mc(o2, true).forEach(function (i3) {
                wg(t2, i3, o2[i3]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(o2))
            : Mc(o2).forEach(function (i3) {
                Object.defineProperty(
                  t2,
                  i3,
                  Object.getOwnPropertyDescriptor(o2, i3)
                );
              });
        }
        return t2;
      ...
      var pb = function () {
        ...
        function u2(u3) {
          ...
          for (null == e2 && (o2 = $2((p2 = ob()))), i2 = 0; i2 <= h2; ++i2)
            !(i2 < h2 && r2((l2 = u3[i2]), i2, u3)) === c2 &&
              ((c2 = !c2) ? o2.lineStart() : o2.lineEnd()),
              c2 && o2.point(+n2(l2, i2, u3), +t2(l2, i2, u3));
          if (p2) return (o2 = null), p2 + "" || null;
        }
        return (
          (u2.x = function (t3) {
            return arguments.length
              ? ((n2 = "function" == typeof t3 ? t3 : c(+t3)), u2)
              : n2;
          }),
          (u2.y = function (n3) {
            return arguments.length
              ? ((t2 = "function" == typeof n3 ? n3 : c(+n3)), u2)
              : t2;
          }),
          (u2.defined = function (n3) {
            return arguments.length
              ? ((r2 = "function" == typeof n3 ? n3 : c(!!n3)), u2)
              : r2;
          }),
          (u2.curve = function (n3) {
            return arguments.length
              ? (($2 = n3), null != e2 && (o2 = $2(e2)), u2)
              : $2;
          }),
          (u2.context = function (n3) {
            return arguments.length
              ? (null == n3 ? (e2 = o2 = null) : (o2 = $2((e2 = n3))), u2)
              : e2;
          }),
          u2
        );
      ...
      function Pc(t2, o2, n2) {
        var i2 = t2._x1 - t2._x0,
          e2 = o2 - t2._x1,
          $2 = (t2._y1 - t2._y0) / (i2 || (e2 < 0 && -0)),
          s2 = (n2 - t2._y1) / (e2 || (i2 < 0 && -0)),
          x2 = ($2 * e2 + s2 * i2) / (i2 + e2);
        return (
          (Oc($2) + Oc(s2)) *
            Math.min(Math.abs($2), Math.abs(s2), 0.5 * Math.abs(x2)) || 0
        );
      }
      function Qc(t2, o2) {
          ...
          if (((o2 = +o2), (t2 = +t2) !== this._x1 || o2 !== this._y1)) {
            switch (this._point) {
              case 0:
                (this._point = 1),
                  this._line
                    ? this._context.lineTo(t2, o2)
                    : this._context.moveTo(t2, o2);
                break;
              case 1:
                this._point = 2;
                break;
              case 2:
                (this._point = 3),
                  qb(this, Qc(this, (n2 = Pc(this, t2, o2))), n2);
                break;
              default:
      ...
      class Ag {
        constructor(
          ...
          (this.options = vg(
            ...
            i2 && ((this.title = i2), (q.top = 60)),
            o2 && ((this.xLabel = o2), (q.bottom = 50)),
            e2 && ((this.yLabel = e2), (q.left = 70)),
            (this.data = { labels: s2, datasets: r2 }),
            (this.filter = "url(#xkcdify)"),
            (this.fontFamily = this.options.fontFamily || "xkcd"),
            this.options.unxkcdify &&
              ((this.filter = null),
            ...
            (this.chart = this.svgEl
              .append("g")
              .attr("transform", `translate(${q.left},${q.top})`)),
            (this.width = this.svgEl.attr("width") - q.left - q.right),
            (this.height = this.svgEl.attr("height") - q.top - q.bottom),
            M(this.svgEl),
            N(this.svgEl),
            this.render();
        }
        render() {
          ...
          const t2 = new L({
              ...
              position: { x: 60, y: 60, type: b.positionType.downRight },
              unxkcdify: this.options.unxkcdify,
              backgroundColor: this.options.backgroundColor,
              strokeColor: this.options.strokeColor,
            }),
            i2 = Qe().domain(this.data.labels).range([0, this.width]),
            o2 = this.data.datasets.reduce((t3, i3) => t3.concat(i3.data), []),
            e2 = A()
              .domain([Math.min(...o2), Math.max(...o2)])
              .range([this.height, 0]),
            s2 = this.chart.append("g").attr("pointer-events", "all");
          y.xAxis(s2, {
            xScale: i2,
            tickCount: 3,
            moveDown: this.height,
          ...
          const r2 = pb()
            .x((t3, o3) => i2(this.data.labels[o3]))
            .y((t3) => e2(t3))
            .curve(Rc);
          s2.selectAll(".xkcd-chart-line")
            .data(this.data.datasets)
            .enter()
            .append("path")
            .attr("class", "xkcd-chart-line")
            .attr("d", (t3) => r2(t3.data))
            .attr("fill", "none")
            .attr("stroke", (t3, i3) => this.options.dataColors[i3])
            .attr("filter", this.filter);
          const a2 = s2
              .append("line")
              .attr("x1", 30)
              ...
              .style("visibility", "hidden"),
            l2 = this.data.datasets.map((t3, i3) =>
              s2
                .append("circle")
                .style("stroke", this.options.dataColors[i3])
                .style("fill", this.options.dataColors[i3])
                .attr("r", 3.5)
                .style("visibility", "hidden")
            );
          if (
            (s2
              ...
              .attr("fill", "none")
              .on("mouseover", () => {
                l2.forEach((t3) => t3.style("visibility", "visible")),
                  a2.style("visibility", "visible"),
                  t2.show();
              })
              .on("mouseout", () => {
                l2.forEach((t3) => t3.style("visibility", "hidden")),
                  a2.style("visibility", "hidden"),
                  t2.hide();
              })
              .on("mousemove", (o3, s3, r3) => {
                const n2 = w(r3[s3])[0] + q.left + 10,
                  $2 = w(r3[s3])[1] + q.top + 10,
                  h2 = this.data.labels
                    .map((t3) => i2(t3) + q.left)
                    .map((t3) => Math.abs(t3 - w(r3[s3])[0] - q.left)),
                  d2 = h2.indexOf(Math.min(...h2));
                a2
                  .attr("x1", i2(this.data.labels[d2]))
                  .attr("x2", i2(this.data.labels[d2])),
                  this.data.datasets.forEach((t3, o4) => {
                    l2[o4]
                      .style("visibility", "visible")
                      .attr("cx", i2(this.data.labels[d2]))
                      .attr("cy", e2(t3.data[d2]));
                  });
                const m2 = this.data.datasets.map((t3, i3) => ({
                  color: this.options.dataColors[i3],
                  text: `${this.data.datasets[i3].label || ""}: ${
                    this.data.datasets[i3].data[d2]
                  }`,
                }));
                let p2 = b.positionType.downRight;
                n2 > this.width / 2 && $2 < this.height / 2
                  ? (p2 = b.positionType.downLeft)
                  : n2 > this.width / 2 && $2 > this.height / 2
                  ? (p2 = b.positionType.upLeft)
                  : n2 < this.width / 2 &&
                    $2 > this.height / 2 &&
                    (p2 = b.positionType.upRight),
                  t2.update({
                    title: this.data.labels[d2],
                    items: m2,
                    position: { x: n2, y: $2, type: p2 },
                  });
              }),
            this.options.showLegend)
          ) {
            const t3 = this.data.datasets.map((t4, i3) => ({
              color: this.options.dataColors[i3],
              text: t4.label,
            }));
            Z(s2, {
      ...
      function Bg(t2) {
        for (var o2 = 1; o2 < arguments.length; o2++) {
          ...
          o2 % 2
            ? Sc(i2, true).forEach(function (o3) {
                Cg(t2, o3, i2[o3]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(i2))
            : Sc(i2).forEach(function (o3) {
                Object.defineProperty(
                  t2,
                  o3,
                  Object.getOwnPropertyDescriptor(i2, o3)
                );
              });
        }
        return t2;
      ...
      function d(t2, r2, e2, n2) {
        ...
        return (
          ...
          (o2.offset = function (t3, e3) {
            return (
              r2((t3 = new Date(+t3)), null == e3 ? 1 : Math.floor(e3)), t3
            );
          }),
          ...
          (o2.filter = function (e3) {
            return d(
              function (r3) {
                if (r3 >= r3) for (; t2(r3), !e3(r3); ) r3.setTime(r3 - 1);
              },
              function (t3, n3) {
                if (t3 >= t3)
                  if (n3 < 0) for (; ++n3 <= 0; ) for (; r2(t3, -1), !e3(t3); );
                  else for (; --n3 >= 0; ) for (; r2(t3, 1), !e3(t3); );
              }
            );
          }),
          e2 &&
            ((o2.count = function (r3, n3) {
              return (
                rb.setTime(+r3),
                sb.setTime(+n3),
                t2(rb),
      ...
      var za = d(
        ...
        function (r2, e2) {
          return (
            (e2 - r2 - (e2.getTimezoneOffset() - r2.getTimezoneOffset()) * D) /
            Tc
          );
        },
        function (r2) {
      ...
      function r(e2) {
        return d(
          function ($2) {
            $2.setDate($2.getDate() - (($2.getDay() + 7 - e2) % 7)),
              $2.setHours(0, 0, 0, 0);
          },
          function (e3, $2) {
          ...
          function (e3, $2) {
            return (
              ($2 -
                e3 -
                ($2.getTimezoneOffset() - e3.getTimezoneOffset()) * D) /
              Uc
            );
          }
        );
      ...
      var Yc = d(
        ...
        function (t2, e2) {
          return (
            e2.getMonth() -
            t2.getMonth() +
            12 * (e2.getFullYear() - t2.getFullYear())
          );
        },
        function (t2) {
          return t2.getMonth();
      ...
      o.every = function (e2) {
        return isFinite((e2 = Math.floor(e2))) && e2 > 0
          ? d(
              function (t2) {
                t2.setFullYear(Math.floor(t2.getFullYear() / e2) * e2),
                  t2.setMonth(0, 1),
                  t2.setHours(0, 0, 0, 0);
              },
              function (t2, r2) {
      ...
      function E($2) {
        return d(
          function (t2) {
            t2.setUTCDate(t2.getUTCDate() - ((t2.getUTCDay() + 7 - $2) % 7)),
              t2.setUTCHours(0, 0, 0, 0);
          },
          function ($3, t2) {
      ...
      var Ng = d(
        ...
        function (t2, e2) {
          return (
            e2.getUTCMonth() -
            t2.getUTCMonth() +
            12 * (e2.getUTCFullYear() - t2.getUTCFullYear())
          );
        },
        function (t2) {
      ...
      F.every = function (e2) {
        return isFinite((e2 = Math.floor(e2))) && e2 > 0
          ? d(
              function (t2) {
                t2.setUTCFullYear(Math.floor(t2.getUTCFullYear() / e2) * e2),
                  t2.setUTCMonth(0, 1),
                  t2.setUTCHours(0, 0, 0, 0);
              },
              function (t2, r2) {
        ...
        var $2 = r2.dateTime,
          ...
          g2 = {
            a: function (r3, $3, e3) {
              ...
              return a3
                ? ((r3.w = f2[a3[0].toLowerCase()]), e3 + a3[0].length)
                : -1;
            },
            A: function (r3, $3, e3) {
              var a3 = H2.exec($3.slice(e3));
              return a3
                ? ((r3.w = v2[a3[0].toLowerCase()]), e3 + a3[0].length)
                : -1;
            },
            b: function (r3, $3, e3) {
              var a3 = l2.exec($3.slice(e3));
              return a3
                ? ((r3.m = d2[a3[0].toLowerCase()]), e3 + a3[0].length)
                : -1;
            },
            B: function (r3, $3, e3) {
              var a3 = m2.exec($3.slice(e3));
              return a3
                ? ((r3.m = s2[a3[0].toLowerCase()]), e3 + a3[0].length)
                : -1;
            },
            c: function (r3, e3, a3) {
            ...
            p: function (r3, $3, e3) {
              ...
              return a3
                ? ((r3.p = i2[a3[0].toLowerCase()]), e3 + a3[0].length)
                : -1;
            },
            Q: kh,
            s: lh,
        ...
        function T2(r3, $3) {
          return function (e3) {
            ...
            for (e3 instanceof Date || (e3 = new Date(+e3)); ++o3 < b3; )
              37 === r3.charCodeAt(o3) &&
                (n3.push(r3.slice(u3, o3)),
                null != (t3 = $c[(a3 = r3.charAt(++o3))])
                  ? (a3 = r3.charAt(++o3))
                  : (t3 = "e" === a3 ? " " : "0"),
                (U3 = $3[a3]) && (a3 = U3(e3, t3)),
                n3.push(a3),
        ...
        function M2(r3, $3) {
          return function (e3) {
            ...
            if (("p" in U3 && (U3.H = (U3.H % 12) + 12 * U3.p), "V" in U3)) {
              ...
              "w" in U3 || (U3.w = 1),
                "Z" in U3
                  ? ((t3 = (a3 = Ea(ba(U3.y))).getUTCDay()),
                    (a3 = t3 > 4 || 0 === t3 ? Ca.ceil(a3) : Ca(a3)),
                    (a3 = ub.offset(a3, 7 * (U3.V - 1))),
                    (U3.y = a3.getUTCFullYear()),
                    (U3.m = a3.getUTCMonth()),
                    (U3.d = a3.getUTCDate() + ((U3.w + 6) % 7)))
                  : ((t3 = (a3 = $3(ba(U3.y))).getDay()),
                    (a3 = t3 > 4 || 0 === t3 ? Aa.ceil(a3) : Aa(a3)),
                    (a3 = za.offset(a3, 7 * (U3.V - 1))),
                    (U3.y = a3.getFullYear()),
                    (U3.m = a3.getMonth()),
                    (U3.d = a3.getDate() + ((U3.w + 6) % 7)));
            } else
              ("W" in U3 || "U" in U3) &&
                ("w" in U3 || (U3.w = "u" in U3 ? U3.u % 7 : "W" in U3 ? 1 : 0),
                (t3 =
                  "Z" in U3 ? Ea(ba(U3.y)).getUTCDay() : $3(ba(U3.y)).getDay()),
                (U3.m = 0),
                (U3.d =
                  "W" in U3
                    ? ((U3.w + 6) % 7) + 7 * U3.W - ((t3 + 5) % 7)
                    : U3.w + 7 * U3.U - ((t3 + 6) % 7)));
            return "Z" in U3
              ? ((U3.H += (U3.Z / 100) | 0), (U3.M += U3.Z % 100), Ea(U3))
              : $3(U3);
          };
        }
      ...
      function bh(r2, $2, e2) {
        var a2 = h.exec($2.slice(e2, e2 + 2));
        return a2
          ? ((r2.y = +a2[0] + (+a2[0] > 68 ? 1900 : 2e3)), e2 + a2[0].length)
          : -1;
      }
      function ch(r2, $2, e2) {
        var a2 = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec($2.slice(e2, e2 + 6));
        return a2
          ? ((r2.Z = a2[1] ? 0 : -(a2[2] + (a2[3] || "00"))), e2 + a2[0].length)
          : -1;
      }
      function dh(r2, $2, e2) {
        var a2 = h.exec($2.slice(e2, e2 + 2));
      ...
      function vh(r2, $2) {
        var e2 = r2.getDay();
        return (
          (r2 = e2 >= 4 || 0 === e2 ? Ba(r2) : Ba.ceil(r2)),
          a(Ba.count(o(r2), r2) + (4 === o(r2).getDay()), $2, 2)
        );
      }
      function wh(r2) {
        return r2.getDay();
      ...
      function Kh(r2, $2) {
        var e2 = r2.getUTCDay();
        return (
          (r2 = e2 >= 4 || 0 === e2 ? Da(r2) : Da.ceil(r2)),
          a(Da.count(F(r2), r2) + (4 === F(r2).getUTCDay()), $2, 2)
        );
      }
      function Lh(r2) {
        return r2.getUTCDay();
      ...
      var Sh = function (e2, t2) {
        var $2,
          r2 = 0,
          M2 = (e2 = e2.slice()).length - 1,
          l2 = e2[r2],
          o2 = e2[M2];
        return (
          o2 < l2 &&
            (($2 = r2), (r2 = M2), (M2 = $2), ($2 = l2), (l2 = o2), (o2 = $2)),
          (e2[r2] = t2.floor(l2)),
          (e2[M2] = t2.ceil(o2)),
          e2
        );
      ...
      function kd(t2, $2, r2, a2, n2, e2, i2, o2, u2) {
        ...
        function h2($3, r3, a3) {
          if ((null == $3 && ($3 = 10), "number" == typeof $3)) {
            ...
            return (
              i3 === M2.length
                ? ((n3 = Ma(r3 / vb, a3 / vb, $3)), ($3 = t2))
                : i3
                ? ((n3 = (i3 =
                    M2[e3 / M2[i3 - 1][2] < M2[i3][2] / e3 ? i3 - 1 : i3])[1]),
                  ($3 = i3[0]))
                : ((n3 = Math.max(Ma(r3, a3, $3), 1)), ($3 = o2)),
              $3.every(n3)
            );
          }
          return $3;
        ...
        return (
          ...
          (k2.ticks = function (t3) {
            ...
            return (
              e3 && (($3 = a3), (a3 = n3), (n3 = $3)),
              ($3 = ($3 = h2(t3, a3, n3)) ? $3.range(a3, n3 + 1) : []),
              e3 ? $3.reverse() : $3
            );
          }),
          ...
          (k2.nice = function (t3) {
            var $3 = X2();
            return (t3 = h2(t3, $3[0], $3[$3.length - 1]))
              ? X2(Sh($3, t3))
              : k2;
          }),
          (k2.copy = function () {
      ...
      var Wh = function () {
        return la.apply(
          kd(o, Yc, tb, za, Xc, Wc, Vc, wa, Og).domain([
            new Date(2e3, 0, 1),
            new Date(2e3, 0, 2),
          ]),
          arguments
      ...
      !(function (t2, n2) {
        ...
        var t2 = "millisecond",
          ...
          c2 = function (t3, n3, e3) {
            var r3 = String(t3);
            return !r3 || r3.length >= n3
              ? t3
              : "" + Array(n3 + 1 - r3.length).join(e3) + t3;
          },
          d2 = {
            s: c2,
            z: function (t3) {
              var n3 = -t3.utcOffset(),
                ...
                i3 = e3 % 60;
              return (
                (n3 <= 0 ? "+" : "-") + c2(r3, 2, "0") + ":" + c2(i3, 2, "0")
              );
            },
            m: function (t3, n3) {
              var e3 = 12 * (n3.year() - t3.year()) + (n3.month() - t3.month()),
                r3 = t3.clone().add(e3, u2),
                i3 = n3 - r3 < 0,
                s3 = t3.clone().add(e3 + (i3 ? -1 : 1), u2);
        ...
        var v2 = (function () {
          ...
          var d3 = c3.prototype;
          return (
            (d3.parse = function (t3) {
              (this.$d = (function (t4) {
                var n3 = t4.date,
                  e3 = t4.utc;
                if (null === n3) return new Date(NaN);
                if (D2.u(n3)) return new Date();
            ...
            (d3.startOf = function (t3, a3) {
              var h3 = this,
                ...
                d4 = function (t4, n3) {
                  var e3 = D2.w(
                    h3.$u ? Date.UTC(h3.$y, n3, t4) : new Date(h3.$y, n3, t4),
                    h3
                  );
                ...
                $3 = function (t4, n3) {
                  return D2.w(
                    h3
                      ...
                      [t4].apply(
                        h3.toDate(),
                        (f3 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(n3)
                      ),
                    h3
                  );
                },
            ...
            (d3.$set = function (s3, a3) {
              var h3,
                ...
                (h3[e2] = c4 + "Minutes"),
                (h3[n2] = c4 + "Seconds"),
                (h3[t2] = c4 + "Milliseconds"),
                h3)[f3],
                $3 = f3 === i2 ? this.$D + (a3 - this.$W) : a3;
              if (f3 === u2 || f3 === o2) {
                var l3 = this.clone().set("date", 1);
                l3.$d[d4]($3),
                  l3.init(),
                  (this.$d = l3
                    .set("date", Math.min(this.$D, l3.daysInMonth()))
                    .toDate());
              } else d4 && this.$d[d4]($3);
            ...
            (d3.format = function (t3) {
              ...
              var e3 = t3 || "YYYY-MM-DDTHH:mm:ssZ",
                r3 = D2.z(this),
                i3 = this.$locale(),
                s3 = this.$H,
                u3 = this.$m,
                ...
                l3 = {
                  ...
                  M: a3 + 1,
                  MM: D2.s(a3 + 1, 2, "0"),
                  MMM: c4(i3.monthsShort, a3, h3, 3),
                  MMMM: h3[a3] || h3(this, e3),
                  D: this.$D,
                  DD: D2.s(this.$D, 2, "0"),
                  d: String(this.$W),
                  dd: c4(i3.weekdaysMin, this.$W, o3, 2),
                  ddd: c4(i3.weekdaysShort, this.$W, o3, 3),
                  dddd: o3[this.$W],
                  H: String(s3),
                  HH: D2.s(s3, 2, "0"),
                  h: d4(1),
            ...
            (d3.diff = function (t3, h3, f3) {
              var c4,
                d4 = D2.p(h3),
                $3 = g2(t3),
                l3 = 6e4 * ($3.utcOffset() - this.utcOffset()),
                m3 = this - $3,
                y3 = D2.m(this, $3);
              return (
                (y3 =
      ...
      class Xh {
        constructor(
          ...
          (this.options = Bg(
            ...
            o2 && ((this.title = o2), (u.top = 60)),
            i2 && ((this.xLabel = i2), (u.bottom = 50)),
            e2 && ((this.yLabel = e2), (u.left = 70)),
            (this.data = { datasets: r2 }),
            (this.filter = "url(#xkcdify)"),
            (this.fontFamily = this.options.fontFamily || "xkcd"),
            this.options.unxkcdify &&
              ((this.filter = null),
            ...
            (this.width = this.svgEl.attr("width") - u.left - u.right),
            (this.height = this.svgEl.attr("height") - u.top - u.bottom),
            M(this.svgEl),
            N(this.svgEl),
            this.render();
        }
        render() {
          ...
          const t2 = new L({
            ...
            position: { x: 60, y: 60, type: b.positionType.dowfnRight },
            unxkcdify: this.options.unxkcdify,
            strokeColor: this.options.strokeColor,
            backgroundColor: this.options.backgroundColor,
          });
          this.options.timeFormat &&
            this.data.datasets.forEach((t3) => {
              t3.data.forEach((t4) => {
                var $dZYI$$interop$default = wb(Fa);
                t4.x = $dZYI$$interop$default.d(t4.x);
              });
            });
          const o2 = this.data.datasets.reduce(
              (t3, o3) => t3.concat(o3.data),
              []
            ),
            i2 = o2.map((t3) => t3.x),
            e2 = o2.map((t3) => t3.y);
          let r2 = A()
            .domain([Math.min(...i2), Math.max(...i2)])
            .range([0, this.width]);
          this.options.timeFormat &&
            (r2 = Wh()
              .domain([Math.min(...i2), Math.max(...i2)])
              .range([0, this.width]));
          const s2 = A()
              .domain([Math.min(...e2), Math.max(...e2)])
              .range([this.height, 0]),
            a2 = this.chart.append("g").attr("pointer-events", "all");
          if (
            (y.xAxis(a2, {
              xScale: r2,
              tickCount:
                void 0 === this.options.xTickCount
                  ? 3
            ...
            y.yAxis(a2, {
              yScale: s2,
              tickCount:
                void 0 === this.options.yTickCount
                  ? 3
            ...
            const t3 = pb()
              ...
              .y((t4) => s2(t4.y))
              .curve(Rc);
            a2.selectAll(".xkcd-chart-xyline")
              .data(this.data.datasets)
              .enter()
              .append("path")
              .attr("class", "xkcd-chart-xyline")
              .attr("d", (o3) => t3(o3.data))
              .attr("fill", "none")
              .attr("stroke", (t4, o3) => this.options.dataColors[o3])
              .attr("filter", this.filter);
          }
          const n2 =
              3.5 *
              (void 0 === this.options.dotSize ? 1 : this.options.dotSize),
            l2 =
              6 * (void 0 === this.options.dotSize ? 1 : this.options.dotSize);
          if (
            (a2
              ...
              .attr("filter", this.filter)
              .attr("xy-group-index", (t3, o3) => o3)
              .selectAll(".xkcd-chart-xycircle-circle")
              .data((t3) => t3.data)
              .enter()
              .append("circle")
              .style("stroke", (t3, o3, i3) => {
                const e3 = Number(
                  f(i3[o3].parentElement).attr("xy-group-index")
                );
              ...
              .attr("cy", (t3) => s2(t3.y))
              .attr("pointer-events", "all")
              .on("mouseover", (o3, i3, e3) => {
                const a3 = Number(
                  f(e3[i3].parentElement).attr("xy-group-index")
                );
                f(e3[i3]).attr("r", l2);
                const n3 = r2(o3.x) + u.left + 5,
                  $2 = s2(o3.y) + u.top + 5;
                let p2 = b.positionType.downRight;
                var $dZYI$$interop$default = wb(Fa);
                n3 > this.width / 2 && $2 < this.height / 2
                  ? (p2 = b.positionType.downLeft)
                  : n3 > this.width / 2 && $2 > this.height / 2
                  ? (p2 = b.positionType.upLeft)
                  : n3 < this.width / 2 &&
                  ...
                  t2.update({
                    title: this.options.timeFormat
                      ? $dZYI$$interop$default
                          .d(this.data.datasets[a3].data[i3].x)
                          .format(this.options.timeFormat)
                      : `${this.data.datasets[a3].data[i3].x}`,
                    items: [
                      {
                        color: this.options.dataColors[a3],
                        text: `${this.data.datasets[a3].label || ""}: ${o3.y}`,
                      },
                    ],
                    position: { x: n3, y: $2, type: p2 },
                  }),
                  t2.show();
              })
            ...
            const t3 = this.data.datasets.map((t4, o3) => ({
              color: this.options.dataColors[o3],
              text: t4.label,
            }));
            Z(a2, {
      ...
      function Yh(t2) {
        for (var e2 = 1; e2 < arguments.length; e2++) {
          ...
          e2 % 2
            ? ld(a2, true).forEach(function (e3) {
                Zh(t2, e3, a2[e3]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(a2))
            : ld(a2).forEach(function (e3) {
                Object.defineProperty(
                  t2,
                  e3,
                  Object.getOwnPropertyDescriptor(a2, e3)
                );
              });
        }
        return t2;
      ...
      md.prototype = {
        ...
        point: function (t2, o2) {
          (t2 = +t2),
            ...
            this._point
              ? this._context.lineTo(t2, o2)
              : ((this._point = 1), this._context.moveTo(t2, o2));
        },
      };
      var $h = function (t2) {
        return new md(t2);
      ...
      class bi {
        constructor(
          t2,
          { title: e2, data: { labels: a2, datasets: r2 }, options: i2 }
        ) {
          (this.options = Yh(
            {
              showLabels: false,
            ...
            (this.title = e2),
            (this.data = { labels: a2, datasets: r2 }),
            (this.directionsCount = r2[0].data.length),
            (this.filter = "url(#xkcdify-pie)"),
            (this.fontFamily = this.options.fontFamily || "xkcd"),
            this.options.unxkcdify &&
              ((this.filter = null),
        ...
        render() {
          ...
          const t2 = new L({
              ...
              title: "",
              items: [],
              position: { x: 0, y: 0, type: b.positionType.downRight },
              unxkcdify: this.options.unxkcdify,
              strokeColor: this.options.strokeColor,
              backgroundColor: this.options.backgroundColor,
            }),
            e2 = 3.5 * (this.options.dotSize || 1),
            a2 = 6 * (this.options.dotSize || 1),
            r2 = Math.min(this.width, this.height) / 2 - _h,
            i2 = (2 * Math.PI) / this.directionsCount,
            o2 = this.data.datasets.reduce((t3, e3) => t3.concat(e3.data), []),
            s2 = Math.max(...o2),
            n2 = Array(this.directionsCount).fill(s2),
            l2 = A().domain([0, s2]).range([0, r2]),
            h2 = (t3, e3) => l2(t3) * Math.cos(i2 * e3 + Ga),
            d2 = (t3, e3) => l2(t3) * Math.sin(i2 * e3 + Ga),
            c2 = pb().x(h2).y(d2).curve($h),
            p2 = l2.ticks(this.options.ticksCount || 3),
            $2 = this.chart
              .append("g")
              ...
              .attr("filter", this.filter);
          $2
            .selectAll(".xkcd-chart-radar-level")
            .data(p2)
            .enter()
            .append("path")
            .attr("class", "xkcd-chart-radar-level")
            .attr("d", (t3) => c2(Array(this.directionsCount).fill(t3)))
            .style("fill", "none")
            .attr("stroke", this.options.strokeColor)
            .attr("stroke-dasharray", "7,7"),
            $2
              .selectAll(".xkcd-chart-radar-line")
              .data(n2)
              .enter()
              .append("line")
              ...
              .attr("y2", d2),
            $2
              .selectAll(".xkcd-chart-radar-tick")
              .data(p2)
              .enter()
              .append("text")
            ...
            this.options.showLabels &&
              $2
                .selectAll(".xkcd-chart-radar-label")
                .data(n2.map((t3) => 1.15 * t3))
                .enter()
                .append("text")
                .attr("class", "xkcd-chart-radar-label")
                .style("font-size", "16")
                .style("fill", this.options.strokeColor)
                .attr("x", (t3, e3) => (r2 + 10) * Math.cos(i2 * e3 + Ga))
                .attr("y", (t3, e3) => (r2 + 10) * Math.sin(i2 * e3 + Ga))
                .attr("dy", ".35em")
                .attr("text-anchor", (t3, e3, a3) => {
                  let r3 = "start";
                  return f(a3[e3]).attr("x") < 0 && (r3 = "end"), r3;
                })
                .text((t3, e3) => this.data.labels[e3]);
          const g2 = this.chart
            .selectAll(".xkcd-chart-radar-group")
            .data(this.data.datasets)
            .enter()
            .append("g")
            .attr("class", "xkcd-chart-radar-group")
            .attr("filter", this.filter)
            .attr("stroke", (t3, e3) => this.options.dataColors[e3])
            .attr("fill", (t3, e3) => this.options.dataColors[e3]);
          if (
            (g2
              .selectAll("circle")
              ...
              .attr("cy", d2)
              .attr("pointer-events", "all")
              .on("mouseover", (e3, r3, i3) => {
                f(i3[r3]).attr("r", a2);
                const o3 = h2(e3, r3) + this.width / 2,
                  s3 = d2(e3, r3) + this.height / 2;
                let n3 = b.positionType.downRight;
                o3 > this.width / 2 && s3 < this.height / 2
                  ? (n3 = b.positionType.downLeft)
                  : o3 > this.width / 2 && s3 > this.height / 2
                  ? (n3 = b.positionType.upLeft)
                  : o3 < this.width / 2 &&
                    s3 > this.height / 2 &&
                    (n3 = b.positionType.upRight),
                  t2.update({
                    title: this.data.labels[r3],
                    items: this.data.datasets.map((t3, e4) => ({
                      color: this.options.dataColors[e4],
                      text: `${t3.label || ""}: ${t3.data[r3]}`,
                    })),
                    position: { x: o3, y: s3, type: n3 },
                  }),
                  t2.show();
              })
            ...
            g2
              ...
              .style("fill-opacity", ai),
            this.options.showLegend)
          ) {
            const t3 = this.data.datasets.map((t4, e4) => ({
                color: this.options.dataColors[e4],
                text: t4.label || "",
              })),
              e3 = this.svgEl.append("g").attr("transform", "translate(0, 30)");
            Z(e3, {
              items: t3,
              position: this.options.legendPosition,
              unxkcdify: this.options.unxkcdify,
...
var SizeHistoryPlugin = class extends import_obsidian.Plugin {
  async onload() {
    this.app.workspace.onLayoutReady(async () => {
      ...
      this.registerInterval(
        window.setInterval(async () => await this.updateHistory(), MS_IN_MINUTE)
      );
    });
  ...
  async updateHistory() {
    ...
    const unregisterdFiles = allFiles.filter(
      (value) => value.stat.ctime > latestTimestamp + MS_IN_DAY
    );
...
var SizeHistoryModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    new SizeHistoryChart(
      svgLine,
      this.history.datapoints,

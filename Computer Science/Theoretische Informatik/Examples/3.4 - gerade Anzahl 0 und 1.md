...
## Idee
### Zustand
- bildet Paritaet der bisher eingelesenen 0s and 1s(siehe s_1 bis s_4)
### Tupel
$A = (\{0, 1\}, \{s_1, s_2, s_3, s_4), \delta, s_4, \{s_4\})$ mit $\delta(s_i, a) := s_j$ fuer alle $s_i \in \{s_1, s_2, s_3, s_4\}$ und $a \in \{0, 1\}$
wobei
$$
j = 
\begin{cases}

...
- wegen [[3.21#$ bar{L} in FA$|1.]] sind $\bar{L}, \bar{L'} \in FA$
- wegen [[3.21#$L cup L in FA$|2.]] sind $\bar{L} \cup \bar{L'} \in FA$
- wegen [[3.21#$ bar{L} in FA$|1.]] sind $\bar{\bar{L} \cup \bar{L'}} \in FA$

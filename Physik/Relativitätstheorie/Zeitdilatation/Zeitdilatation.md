...
- siehe [[Lichtuhr#bewegte Lichtuhr|bewegte Lichtuhr]]

![[Zeitdilatation 2025-06-26 21.19.14.excalidraw|400]]
$$
x_{1} = v \cdot t 
$$
$$
...
$$
$$
\implies t = \sqrt{ \frac{1}{1-\left( \frac{v}{c} \right)^2} }\cdot t_{0} = \gamma \cdot t_{0}
$$
-> [[Lorenzfaktor]]($\gamma$)
